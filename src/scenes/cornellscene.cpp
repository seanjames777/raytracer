...
CornellScene::CornellScene() {
    ...
    addMesh(mesh1, float3(0.0f, 5.0f, 0.0f), float3(0.0f, 0.0f, 0.0f), 10.0f, true);
    ...
    addMesh(mesh2, float3(0.0f, 5.0f, 0.0f), float3(0.0f, 0.0f, 0.0f), 10.0f, true);
    ...
    addMesh(mesh3, float3(0.0f, 5.0f, 0.0f), float3(0.0f, 0.0f, 0.0f), 10.0f, true);

#if 1
    auto mesh4 = MeshLoader::load(relToExeDir("content/models/box.fbx"));
    addMesh(mesh4, float3(1.5f, 1.5f, -1.5f), float3(0.0f, (float)M_PI / 180.0f * 20.0f, 0.0f), 3.0f);
    addMesh(mesh4, float3(-2.0f, 3.0f, 1.5f), float3(0.0f, (float)M_PI / 180.0f * -20.0f, 0.0f), float3(3.0f, 6.0f, 3.0f));
#endif

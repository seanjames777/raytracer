...
public:
	...
	template<unsigned int N>
	vector<bmask, N> intersectPacket(THREAD KDPacketStackFrame<N> *stackMem, const Packet<N> & packet, THREAD const vector<float, N> & tmax, THREAD PacketCollision<N> & result);
